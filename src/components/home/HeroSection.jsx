  ...
  const slides = [
    {
      id: 3,
      imageUrl:
        "https://images.unsplash.com/photo-1495238476940-83c355adcac9?ixlib=rb-4.1.0&q=85&fm=jpg&crop=entropy&cs=srgb",
      ...
      styles: {
        ...
        secondaryButton:
          "bg-transparent text-[#d7c797] border-white/30 hover:border-secondary",
      },
    },
    {
      id: 1,
      imageUrl:
        "https://images.unsplash.com/photo-1589623003309-c2b7071aef95?ixlib=rb-4.1.0&q=85&fm=jpg&crop=entropy&cs=srgb",
      ...
      styles: {
        ...
        secondaryButton:
          "bg-transparent text-white border-white/30 hover:border-secondary",
      },
    },
  ];
            ...
            >
              ...
              >
                <span className="text-lg">
                  {currentSlide.secondaryAction.icon}
                </span>
                {screenSize === "xs"
                  ? "Report"
