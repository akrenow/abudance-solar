                ...
                <div className="max-w-5xl mx-auto bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden flex flex-col md:flex-row items-center">
                    ...
                    <div className="md:w-1/2 w-full p-8 md:p-12 flex flex-col justify-center">
                        ...
                        <p className="text-gray-700 text-lg mb-4">
                            Abundance Solar is at the forefront of solar manufacturing in the UAE,
                            driving the global transition to sustainable energy with advanced
                            technology and innovation.
                        </p>
                        <p className="text-gray-600 text-base mb-2">
                            Our mission is to deliver high-quality, reliable solar solutions for a brighter, greener future. We are committed to sustainability, innovation, and excellence in every panel we produce.
                        </p>
                        <a
                            href="/about"
